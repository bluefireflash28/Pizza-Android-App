...
// Set up the OnItemSelectedListener
    ...
    public void placeOrder(View view) {
        ...
        if (!getPizzaType().equals("Build Your Own")) {
            Pizza a = currentOrderActivity.addChicagoPizza(getPizzaSize(),getPizzaType());
            showOrderPopup();
            ...
            Pizza b = currentOrderActivity.addChicagoPizzaBYO(getPizzaSize(), toppingList);
            showOrderPopup();
...
// Show the dialog
    ...
    public void setCrust(String type){
        ...
        switch(type){
            case "Deluxe":
                crust.setText(getString(R.string.deepdish));
                availableToppings.setEnabled(false);
                addTopping.setEnabled(false);
                removeTopping.setEnabled(false);
                break;
            case "BBQ Chicken":
                crust.setText(getString(R.string.pan));
                availableToppings.setEnabled(false);
                addTopping.setEnabled(false);
                removeTopping.setEnabled(false);
                break;
            case "Meatzza":
                crust.setText(getString(R.string.stuffed));
                availableToppings.setEnabled(false);
                addTopping.setEnabled(false);
                removeTopping.setEnabled(false);
                break;
            case "Build Your Own":
                crust.setText(R.string.pan);
